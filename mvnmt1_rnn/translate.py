...
def main(option_file, model, dictionary, dictionary_target, source_file, saveto, k=5,
...
if __name__ == "__main__":
    ...
    main(args.o, args.model, args.dictionary, args.dictionary_target, args.source,
