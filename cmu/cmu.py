...
def init_params(options):
    assert options['dim_word'] == options['dim_pic']
...
def train(dim_word=100,  # word vector dimensionality
    ...
    for eidx in xrange(max_epochs):
        ...
        for x, y, pi in train:
            ...
            #print(x)
            #print(x_mask.shape)
            #print(x_mask.sum(axis=0))
            #print(y.shape)
            #print(y)
            #print(y_mask.shape)
            #print(y_mask.sum(axis=0))
            #print(pi.shape)
            #print(pi)
            #print(pi_mask.shape)
            #print(pi_mask.sum(axis=0))

            # compute cost, grads and copy grads to shared variables
            cost = f_grad_shared(x, x_mask, y, y_mask, pi, pi_mask)
