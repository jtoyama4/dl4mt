...
def param_init_gru_cond(options, params, prefix='gru_cond',
    ...
    Vc2 = norm_weight(dimv,dim*2)
    params[_p(prefix, 'Vc')] = Vc
    params[_p(prefix, 'Vc2')] = Vc2
    
    Vcx = norm_weight(dimv, dim)
    params[_p(prefix, 'Vcx')] = Vcx
    Vcx2 = norm_weight(dimv, dim)
    params[_p(prefix, 'Vcx2')] = Vcx2
...
def gru_cond_layer(tparams, state_below, options, prefix='gru',
    ...
    def _step_slice(m_, x_, xx_, h_, ctx_, alpha_, pctx_, cc_,he,
                    U, Wc, Vc, Vc2, W_comb_att, U_att, c_tt, Ux, Wcx, Vcx, Vcx2, U_nl, Ux_nl, b_nl, bx_nl):
...
def train(dim_word=100,  # word vector dimensionality
    ...
    for eidx in xrange(max_epochs):
        ...
        for x, y in train:
            ...
            cost, kl_cost = f_grad_shared(x, x_mask, y, y_mask)
