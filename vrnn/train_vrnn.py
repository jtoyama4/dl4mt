...
def main(job_id, params):
    ...
    validerr = train(saveto=params['model'][0],
                     ...
                     datasets=['%s/flickr30k/s_caption_train.txt' % basedir,
                               '%s/flickr30k/kelvin_feature/train-cnn_features.hdf5' % basedir],
                     valid_datasets=['%s/flickr30k/bitext.val.en.tok.txt' % basedir,
                                     '%s/flickr30k/kelvin_feature/dev-cnn_features.hdf5' % basedir],
...
if __name__ == '__main__':
    ...
    main(0, {
        'model': ['%s/models/vrnn/model_big_6_vrnn_captioning.npz' % basedir],
